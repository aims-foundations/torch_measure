...
def _register_helm_datasets() -> dict[str, DatasetInfo]:
    ...
    datasets["truthfulqa"] = DatasetInfo(
        name="truthfulqa",
        family="helm",
    ...
    datasets["commonsense"] = DatasetInfo(
        name="commonsense",
        family="helm",
    ...
    datasets["synthetic_reasoning"] = DatasetInfo(
        ...
        n_subjects=_N_SUBJECTS,
        n_items=2234,
        filename="synthetic_reasoning.pt",
        citation=_HELM_CITATION,
        url=_HELM_URL,
        license="MIT",
    ...
    datasets["dyck_language"] = DatasetInfo(
        name="dyck_language",
        family="helm",
    ...
    datasets["civil_comments"] = DatasetInfo(
        name="civil_comments",
        family="helm",
    ...
    datasets["legalbench"] = DatasetInfo(
        name="legalbench",
        family="helm",
    ...
    datasets["legal_support"] = DatasetInfo(
        name="legal_support",
        family="helm",
    ...
    datasets["air_bench_2024"] = DatasetInfo(
        name="air_bench_2024",
        family="helm",
    ...
    datasets["entity_matching"] = DatasetInfo(
    ...
    datasets["entity_data_imputation"] = DatasetInfo(
        ...
        n_subjects=_N_SUBJECTS,
        n_items=395,
        filename="entity_data_imputation.pt",
        citation=_HELM_CITATION,
        url=_HELM_URL,
        license="MIT",
    ...
    datasets["thai_exam"] = DatasetInfo(
        name="thai_exam",
        family="helm",
