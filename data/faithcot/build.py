"""
01_build_response_matrix.py — Download and process FaithCoT-BENCH dataset.

Downloads the FaithCoT-BENCH repository (chain-of-thought faithfulness benchmark evaluating
whether LLM reasoning chains are faithful to their final answers) from
https://github.com/se7esx/FaithCoT-BENCH, then discovers CSV/JSON data files, summarizes
faithfulness annotations, and saves a catalog of processed results.
...
def download():
    ...
    if repo_dir.exists():
        print("FaithCoT-BENCH already cloned, skipping download")
        return
    print("Cloning FaithCoT-BENCH repo...")
    subprocess.run(
        ["git", "clone", "--depth", "1", "https://github.com/se7esx/FaithCoT-BENCH.git", str(repo_dir)],
        check=True,
    )
