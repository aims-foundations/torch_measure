"""
01_build_response_matrix.py — Download and process Apollo Deception Detection dataset.

Downloads the deception-detection repository from Apollo Research
(https://github.com/ApolloResearch/deception-detection), then explores probe datasets
including AI Liar, Roleplaying, Insider Trading, Sandbagging, AI Audit, Werewolf,
Geometry of Truth, TruthfulQA, and Rollouts. Summarizes honest/deceptive/ambiguous
labels per dataset.
"""
...
def download():
    ...
    if repo_dir.exists():
        print("deception-detection already cloned, skipping download")
        return
    print("Cloning deception-detection repo...")
    subprocess.run(
        ["git", "clone", "--depth", "1", "https://github.com/ApolloResearch/deception-detection.git", str(repo_dir)],
        check=True,
    )
