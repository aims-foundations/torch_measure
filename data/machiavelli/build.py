"""
01_build_response_matrix.py — Download and process Machiavelli Benchmark dataset.

Downloads the machiavelli repository (https://github.com/aypan17/machiavelli) which uses
text-based choose-your-own-adventure games to measure power-seeking, deception, and other
harmful behaviors, then explores the game/annotation structure and summarizes ethical
annotations from experiment results.
...
def download():
    ...
    if repo_dir.exists():
        print("machiavelli already cloned, skipping download")
        return
    print("Cloning machiavelli repo...")
    subprocess.run(
        ["git", "clone", "--depth", "1", "https://github.com/aypan17/machiavelli.git", str(repo_dir)],
        check=True,
    )
    print("Done cloning repository.")
    print()
    print("NOTE: The full game data may need to be downloaded separately.")
    print("Check the repository README for Google Drive download instructions.")
