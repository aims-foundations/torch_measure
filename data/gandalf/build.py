"""
01_build_response_matrix.py — Download and process Gandalf Ignore Instructions dataset.

Downloads Lakera Gandalf dataset (~279K prompt injections) from HuggingFace.
...
def download():
    """Download Lakera Gandalf dataset from HuggingFace."""
    RAW_DIR.mkdir(parents=True, exist_ok=True)

    dataset_dir = RAW_DIR / "gandalf_ignore_instructions"
