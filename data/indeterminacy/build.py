...
INFO = {
    'description': """Build Indeterminacy Experiments response matrices from multi-judge LLM evaluation data""",
    'testing_condition': '',
    'paper_url': 'https://arxiv.org/abs/2306.05685',
    'data_source_url': 'https://huggingface.co/datasets/lguerdan/indeterminacy-experiments',
    'subject_type': 'model',
    'item_type': 'task',
    'license': 'CC-BY-4.0',
