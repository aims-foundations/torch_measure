#!/usr/bin/env python3
"""01_build_response_matrix.py -- Download and process NHTSA SGO crash report data.
...
def download():
    ...
    for filename, url in FILES.items():
        ...
        print(f"[INFO] Downloaded {filename}: {n_lines} lines")

    print("[INFO] NHTSA SGO download complete.")
...
def main():
    ...
    if col_make and col_crash:
        ...
        # Save item content
        items = pd.DataFrame({
            "item_id": binary_bool.columns,
            "content": binary_bool.columns,
        })
