#!/usr/bin/env python3
"""01_build_response_matrix.py -- Download and process Responsible AI Measures Dataset.
...
def download():
    ...
    zip_file = RAW_DIR / "rai_measures_dataset.zip"

    if zip_file.exists():
        print("Dataset already downloaded, skipping")
        return

    print("Downloading RAI Measures Dataset from Figshare...")
    urllib.request.urlretrieve(
        "https://ndownloader.figshare.com/files/57701437", zip_file
    )
    print("Downloaded. Unzipping...")
    subprocess.run(["unzip", "-o", str(zip_file)], cwd=str(RAW_DIR), check=True)
