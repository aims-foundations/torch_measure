"""
01_build_response_matrix.py — Download and process CoT Unfaithfulness dataset.

Downloads from: https://github.com/milesaturpin/cot-unfaithfulness
...
def download():
    ...
    if repo_dir.exists():
        print("cot-unfaithfulness already cloned, skipping")
        return

    print("Cloning cot-unfaithfulness repo...")
    subprocess.run(
        ["git", "clone", "--depth", "1", "https://github.com/milesaturpin/cot-unfaithfulness.git", str(repo_dir)],
        check=True,
    )
