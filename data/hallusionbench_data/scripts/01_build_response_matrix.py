"""
Build HallusionBench response matrix from VLMEval/OpenVLMRecords.

Data source:
  - HuggingFace dataset: VLMEval/OpenVLMRecords
  - Per-model xlsx files at mmeval/{model}/{model}_HallusionBench.xlsx
  - Hallucination detection benchmark (binary yes/no)
...
Outputs:
  - raw/{model}_HallusionBench.xlsx: Downloaded xlsx files
...
BENCHMARK_SUFFIX = "HallusionBench"
...
def main():
    print(f"HallusionBench Response Matrix Builder")
    print("=" * 60)
