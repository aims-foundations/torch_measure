...
SPECS_NEW = [
    ...
    BenchmarkSpec(
        benchmark="tumlu",
        csv_file="response_matrix.csv",
        registry_name="bench/tumlu",
        response_type="binary",
        orientation="models_as_rows",
        description="TUMLU — Turkic MMLU across 9 languages (30 models, 7.5K items)",
        url="https://github.com/ceferisbarov/TUMLU",
        tags=["multilingual", "turkic", "knowledge"],
        content_file="item_content.csv",
        content_key="item_id",
        content_col="content",
    ),
    BenchmarkSpec(
        benchmark="rakuda",
        csv_file="response_matrix.csv",
        registry_name="bench/rakuda",
        response_type="continuous",
        orientation="models_as_rows",
        description="Rakuda — Japanese open-ended QA (141 models, GPT-4 judge scores)",
        url="https://github.com/shisa-ai/shaberi",
        tags=["japanese", "open-ended", "llm-judge"],
        content_file="item_content.csv",
        content_key="item_id",
        content_col="content",
    ),
    BenchmarkSpec(
        benchmark="tengu",
        csv_file="response_matrix.csv",
        registry_name="bench/tengu",
        response_type="continuous",
        orientation="models_as_rows",
        description="Tengu-Bench — Japanese multi-category eval (141 models, GPT-4 judge scores)",
        url="https://github.com/shisa-ai/shaberi",
        tags=["japanese", "open-ended", "llm-judge"],
        content_file="item_content.csv",
        content_key="item_id",
    ...
    BenchmarkSpec(
        ...
        response_type="binary",
        orientation="models_as_rows",
        description="IgakuQA — Japanese medical exam QA (5 models, 1,471 items, 2018-2022)",
        url="https://github.com/jungokasai/IgakuQA",
        tags=["japanese", "medical", "domain-specific"],
        index_col="model_id",
        content_file="item_content.csv",
        content_key="item_id",
        content_col="problem_text",
    ),
    BenchmarkSpec(
        benchmark="ai2d_test",
        csv_file="response_matrix.csv",
        registry_name="bench/ai2d_test",
        response_type="binary",
        orientation="models_as_rows",
        description="AI2D_TEST — science diagram understanding MCQ (192 VLMs, 3K items)",
        url="https://allenai.org/data/diagrams",
        tags=["vision", "vlm", "science", "mcq"],
        index_col="model",
        content_file="item_content.csv",
        content_key="index",
        content_col="question",
    ...
    BenchmarkSpec(
        ...
        csv_file="response_matrix.csv",
        registry_name="bench/hallusionbench",
        response_type="binary",
        orientation="models_as_rows",
        description="HallusionBench — VLM hallucination detection, yes/no (191 VLMs, 951 items)",
        url="https://github.com/tianyi-lab/HallusionBench",
        tags=["vision", "vlm", "hallucination", "yesno"],
        index_col="model",
        content_file="item_content.csv",
        content_key="index",
        content_col="question",
    ...
    BenchmarkSpec(
        ...
        csv_file="response_matrix.csv",
        registry_name="bench/mathvista_mini",
        response_type="binary",
        orientation="models_as_rows",
        description="MathVista_MINI — mathematical reasoning with vision, mixed MCQ+free-form (195 VLMs, 1K items)",
        url="https://mathvista.github.io/",
        tags=["vision", "vlm", "math", "reasoning"],
        index_col="model",
        content_file="item_content.csv",
        content_key="index",
        content_col="question",
    ...
    BenchmarkSpec(
        benchmark="mmbench_v11",
        csv_file="response_matrix.csv",
        registry_name="bench/mmbench_v11",
        response_type="binary",
        orientation="models_as_rows",
        description="MMBench V1.1 — MCQ vision understanding, dev split (179 VLMs, 4.9K items)",
        url="https://mmbench.opencompass.org.cn/",
        tags=["vision", "vlm", "mcq", "understanding"],
        index_col="model",
        content_file="item_content.csv",
        content_key="index",
        content_col="question",
    ...
    BenchmarkSpec(
        benchmark="mme",
        csv_file="response_matrix.csv",
        registry_name="bench/mme",
        response_type="binary",
        orientation="models_as_rows",
        description="MME — binary yes/no vision perception + cognition (232 VLMs, 2.4K items)",
        url="https://github.com/BradyFU/Awesome-Multimodal-Large-Language-Models",
        tags=["vision", "vlm", "perception", "yesno"],
        index_col="model",
        content_file="item_content.csv",
        content_key="index",
        content_col="question",
    ...
    BenchmarkSpec(
        benchmark="mmmu_dev_val",
        csv_file="response_matrix.csv",
        registry_name="bench/mmmu_dev_val",
        response_type="binary",
        orientation="models_as_rows",
        description="MMMU DEV_VAL — college-level multimodal MCQ, validation split (183 VLMs, 900 items)",
        url="https://mmmu-benchmark.github.io/",
        tags=["vision", "vlm", "mcq", "college-level"],
        index_col="model",
        content_file="item_content.csv",
        content_key="index",
        content_col="question",
